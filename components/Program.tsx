...
export default function Program() {
    return (
        <section id="program-airrobot" className="section-padding bg-[#1A1A1A] relative overflow-hidden">
                    ...
                    <ScrollAnimation direction="right" delay={100}>
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h4 className="text-2xl font-bold mb-4 text-white group-hover:text-active-orange transition-colors">Basic Course</h4>
