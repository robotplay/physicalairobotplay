...
export default function About() {
    ...
    return (
        <section id="about" className="py-12 sm:py-16 md:py-20 bg-[#1A1A1A]">
                                ...
                                {values.map((value, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <h4 className="text-xl sm:text-2xl font-bold text-white mb-3 group-hover:text-deep-electric-blue transition-colors">
                                                {value.title}
                                            </h4>
                        ...
                        <div className="relative bg-gradient-to-br from-deep-electric-blue/10 via-active-orange/10 to-neon-purple/10 rounded-3xl p-8 sm:p-12 md:p-16 border border-deep-electric-blue/20">
                            <div className="text-center max-w-4xl mx-auto">
                                ...
                                <div className="border-t border-deep-electric-blue/30 pt-6 sm:pt-8">
                                    ...
                                    <p className="text-base sm:text-lg text-gray-300">
                                        <strong className="text-white">피지컬 AI 로봇플레이 대표 하광진</strong>
                                    </p>
                                </div>
                            </div>
                        </div>
