...
class AutonomousRobot {
    void navigate() {
        ...
        },
        {
            number: '04',
            icon: Bot,
            title: 'ROS-Based Humanoid',
            subtitle: 'Robot Operating System',
            headline: '로봇 운영 체제(ROS) 기반의 AI 휴머노이드 로봇',
            description: '산업 표준 로봇 운영 체제인 ROS를 통해 휴머노이드 로봇을 제어합니다. 노드 기반 아키텍처, 토픽 통신, 서비스 호출 등 ROS의 핵심 개념을 학습하고, 실제 휴머노이드 로봇을 프로그래밍하여 걷기, 물체 잡기, 대화하기 등 복합적인 작업을 수행합니다.',
            keywords: ['#ROS', '#휴머노이드', '#노드통신'],
            color: 'from-green-500 to-emerald-500',
            bgColor: 'from-green-900/20 to-emerald-900/20',
            code: `# ROS Python Example
import rospy
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
                <ScrollAnimation direction="fade">
                    <div className="text-center mb-16">
                        <h2 className="text-neon-purple font-bold tracking-wider mb-2">THE 4 PILLARS OF TECHNOLOGY</h2>
                        ...
                        return (
                            ...
                            >
                                <div className={`group relative rounded-2xl sm:rounded-3xl overflow-hidden border border-gray-800 active:border-neon-purple/50 hover:border-neon-purple/50 transition-all duration-500 active:-translate-y-1 hover:-translate-y-2 ${
                                    ...
                                    <div className={`relative z-10 grid grid-cols-1 md:grid-cols-2 gap-0 ${isEven ? '' : 'md:flex-row-reverse'}`}>
                                        {/* Left: Image/Visual */}
                                        <div className={`relative h-48 sm:h-56 md:h-64 lg:h-auto bg-gradient-to-br ${pillar.bgColor} border-b md:border-b-0 md:border-r border-gray-800 ${isEven ? '' : 'md:border-l md:border-r-0'}`}>
                                        ...
                                        {/* Right: Content */}
                                        <div className="p-6 sm:p-8 md:p-12 bg-black/40 backdrop-blur-sm">
                                            <div className="mb-4">
