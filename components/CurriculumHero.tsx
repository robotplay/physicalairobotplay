...
export default function CurriculumHero() {
  ...
  return (
    <section className="relative h-[60vh] min-h-[400px] sm:min-h-[500px] flex items-center justify-center overflow-hidden pt-16 sm:pt-20 bg-[#1A1A1A]">
      {/* Animated background */}
      ...
      <div className={`relative z-[10] text-center px-4 max-w-4xl mx-auto transition-all duration-1000 ${
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-deep-electric-blue/20 backdrop-blur-md rounded-full border border-deep-electric-blue/30 mb-6 animate-fade-in">
