...
**신용카드 결제 테스트**
```
카드번호: 4092-0200-1234-5678 (Visa)
유효기간: 12/29 (미래 날짜 아무거나)
CVC: 123 (아무 3자리 숫자)
생년월일: 991122 (아무 6자리 숫자)
카드 비밀번호: 12 (아무 2자리 숫자)
```

**다른 테스트 카드**
| 카드사 | 카드번호 | 비고 |
|--------|----------|------|
| BC카드 | 5443-8100-0000-0008 | 정상 승인 |
| 국민카드 | 4811-1234-5678-9012 | 정상 승인 |
| 하나카드 | 5468-1234-5678-9012 | 정상 승인 |
| 신한카드 | 4123-4500-0000-0008 | 정상 승인 |

**주의사항**
- ⚠️ 테스트 환경에서만 사용 가능
- 실제 결제는 발생하지 않음
- PortOne 대시보드에서 "테스트 모드" 활성화 필수
- 모든 입력 값은 형식만 맞으면 됨 (실제 정보 불필요)
