...
export default function AdvancedCourseHero() {
    ...
    return (
        <section className="relative h-screen min-h-[500px] sm:min-h-[600px] md:min-h-[700px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#1A1A1A] via-[#0F0F0F] to-[#1A1A1A] pt-16 sm:pt-20">
            ...
            <div className="absolute top-20 right-10 w-96 h-64 bg-black/80 backdrop-blur-sm rounded-lg border border-neon-purple/30 p-4 opacity-0 md:opacity-100 transition-opacity">
            ...
            <div className={`relative z-10 text-center px-4 max-w-5xl mx-auto transition-all duration-1000 ${
                ...
                <p className="text-base md:text-lg text-gray-400 mb-10 max-w-3xl mx-auto">
                    블록을 넘어 실제 개발 언어(Python/C++)로. AI 비전과 자율주행 기술을 통해<br className="hidden md:block" />
                    스스로 생각하고 판단하는 로봇을 설계합니다.
                </p>

                <div className="flex flex-col md:flex-row gap-4 justify-center">
                    <button className="px-8 py-4 bg-gradient-to-r from-neon-purple to-deep-electric-blue hover:from-purple-600 hover:to-blue-600 text-white font-bold rounded-lg transition-all transform hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(157,0,255,0.5)] hover:shadow-[0_0_40px_rgba(157,0,255,0.7)] flex items-center justify-center gap-2">
