...
import { Code2, Eye, Navigation } from 'lucide-react';
                    ...
                    {pillars.map((pillar, index) => {
                        ...
                        return (
                            <ScrollAnimation
                                ...
                                delay={index * 200}
                            >
                                <div className={`group relative rounded-3xl overflow-hidden border border-gray-800 hover:border-neon-purple/50 transition-all duration-500 ${
