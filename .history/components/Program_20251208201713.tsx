            ...
            <div className="relative z-10">
                ...
                <ScrollAnimation direction="left" delay={200}>
                    <a
                        ...
                        className="group relative bg-deep-electric-blue rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 overflow-hidden text-white hover:scale-[1.02] block"
                    >
                            {/* Animated background blob */}
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="w-full py-3 rounded-xl bg-white text-deep-electric-blue font-bold hover:bg-blue-50 transition-all flex items-center justify-center gap-2 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl cursor-pointer">
                                    상세 커리큘럼
                                    <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                                </div>
                            </div>
