                    ...
                    {steps.map((step, index) => {
                        ...
                        return (
                            <ScrollAnimation
                                ...
                                delay={index * 200}
                            >
                                <div className={`group relative bg-white dark:bg-gray-900 rounded-3xl p-8 md:p-12 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden border border-gray-100 dark:border-gray-800 ${
                                    ...
                                    <div className={`relative z-10 grid md:grid-cols-2 gap-8 items-center ${index % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                                        {/* Left: Content */}
                                        ...
                                        <div className={`relative ${index % 2 === 0 ? '' : 'md:order-1'}`}>
                                            <div className="relative h-64 rounded-2xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 group-hover:scale-105 transition-transform duration-500">
                                                {/* Placeholder for visual */}
                                                <div className="w-full h-full flex items-center justify-center">
                                                    <div className="text-center">
                                                        <div className={`w-24 h-24 mx-auto mb-4 bg-gradient-to-br ${step.color} rounded-2xl flex items-center justify-center group-hover:rotate-12 transition-transform`}>
                                                            <Icon className="w-12 h-12 text-white" />
                                                        </div>
                                                        <p className="text-sm text-gray-500 dark:text-gray-400">{step.visual}</p>
                                                    </div>
                                                </div>
