            ...
            <div className="relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    <ScrollAnimation direction="right" delay={100}>
                        <div className="group relative bg-white dark:bg-gray-900 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 overflow-hidden border border-gray-100 dark:border-gray-800 hover:border-active-orange/50">
