...
import { BookOpen, Wrench, Plane, Trophy, Play } from 'lucide-react';
                            ...
                            >
                                <div className="group relative bg-gray-800 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-xl active:shadow-2xl hover:shadow-2xl transition-all duration-500 active:-translate-y-1 hover:-translate-y-2 overflow-hidden border border-gray-700">
                                    ...
                                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
                                        {/* Left: Visual */}
                                        {index === 0 ? (
                                            /* YouTube Video for first step - Click to play */
                                            <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden bg-gray-900 border border-gray-700 group cursor-pointer" onClick={() => setPlayingVideos({ ...playingVideos, 0: true })}>
                                                {!playingVideos[0] ? (
                                                    <>
                                                        {/* Thumbnail */}
                                                        <div className="absolute inset-0 bg-gradient-to-br from-sky-900/20 to-blue-900/20 flex items-center justify-center">
                                                            <div className="text-center">
                                                                <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-sky-400 to-blue-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-all shadow-lg">
                                                                    <BookOpen className="w-12 h-12 text-white" />
                                                                </div>
                                                                <div className="text-6xl font-black text-gray-700">01</div>
                                                            </div>
                                                        </div>
                                                        {/* Play Button Overlay */}
                                            ...
                                            /* Image for second step */
                                            <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden bg-gray-900 border border-gray-700 group">
                                                <Image
                                                    src="/img/drone1.JPG"
                                                    alt="DIY SW 드론 제어 - Creative Drone Lab"
                                                    fill
                                            ...
                                            /* YouTube Shorts Video for fourth step - Click to play */
                                            <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden bg-gray-900 border border-gray-700 group cursor-pointer" onClick={() => setPlayingVideos({ ...playingVideos, 3: true })}>
                                                {!playingVideos[3] ? (
                                                    <>
                                                        {/* Thumbnail */}
                                                        <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 to-pink-900/20 flex items-center justify-center">
                                                            <div className="text-center">
                                                                <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-all shadow-lg">
                                                                    <Trophy className="w-12 h-12 text-white" />
                                                                </div>
                                                                <div className="text-6xl font-black text-gray-700">04</div>
                                                            </div>
                                                        </div>
                                                        {/* Play Button Overlay */}
                                                        <div className="absolute inset-0 flex items-center justify-center bg-black/20 group-hover:bg-black/30 transition-colors duration-300">
