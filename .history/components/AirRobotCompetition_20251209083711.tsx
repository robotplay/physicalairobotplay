                        ...
                        return (
                            ...
                            >
                                <div className="group relative bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-800 hover:border-sky-400/50 transition-all duration-300 hover:-translate-y-2">
                                    ...
                                    {achievement.logo ? (
                                        <div className="w-16 h-16 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center mb-6 p-2 group-hover:scale-110 transition-all border border-gray-700">
                                            <Image
