...
export default function Teachers() {
    ...
    const teachers: Teacher[] = [
        ...
        },
        {
            name: '이지은',
            title: '창의과학 교육 전문강사',
            specialty: '로봇코딩·드론·항공과학 교육',
            image: '/img/lje.png',
            skills: [
                { name: 'Block/Entry/Scratch', level: 100 },
                { name: 'AI Drone Coding', level: 95 },
                { name: 'Aerospace Science', level: 95 },
                { name: 'Creative Science', level: 100 },
            ],
            experience: [
                '로봇코딩 강사 [블록&엔트리&스크래치 코딩]',
                'AI드론 항공코딩 강사 [코딩드론 에어로봇]',
                '나로에어 코딩드론 & 항공과학 프로그램 강사',
                '"미래로 우리아이 코딩" 열린교실 코딩강사',
                '충청남도 늘봄학교 (새샘외 다수) 창의과학 전문강사',
                '(주) NEU엔터테인먼트 [로봇SW강사]',
                '(사) KICT기업인협회 [교육 및 컨설팅 매니져]',
                '글로벌 인재 양성을 위한 로봇코딩 강의 [천안 호서대학교 유학생대상]',
                'STEAMCUP AI 로봇대회 운영진 (재)아산시청소년재단',
        ...
        },
        {
            name: '정세나',
            title: '창의과학 교육 전문강사',
            specialty: '로봇코딩·창의과학·로봇SW 교육',
            image: '/img/jsn.png',
            skills: [
                { name: 'Creative Science', level: 100 },
                { name: 'Robot SW', level: 95 },
                { name: 'Robot Coding', level: 95 },
                { name: 'Teaching Expertise', level: 100 },
            ],
            experience: [
                '충청남도 늘봄 창의과학 강사 (주강사: 월봉초, 신대초 / 보조강사: 용소초, 신용초)',
                '(주) NEU엔터테인먼트 로봇SW강사',
                '(사) KICT기업인협회 교육 및 컨설팅 매니져',
                '(재)아산시청소년재단 STEAMCUP AI 로봇대회 심사위원',
                '글로벌 인재 양성을 위한 로봇코딩 보조강사 [천안 호서대학교 유학생대상]',
                '천안시직장맘센터 "미래로 우리아이 코딩" 보조강사',
                '로봇플레이학원 교육강사',
                '(주) NEU엔터테인먼트 교육강사',
            ],
        },
        {
            ...
            experience: [
                '나로에어 코딩드론 & 항공과학 프로그램 강사',
                '충청남도 늘봄학교 천안 신용초등학교 창의과학 늘봄 강사 [항공우주꿈나무 수업]',
                '(주) NEU엔터테인먼트 [로봇SW강사]',
                '(사) KICT기업인협회 [교육 및 컨설팅 매니져]',
                '글로벌 인재 양성을 위한 로봇 코딩 강의 [천안 호서대학교 유학생대상]',
                'STEAMCUP AI 로봇대회 운영진 (재)아산시청소년재단',
                'AI드론 항공코딩 강사 [코딩드론 에어로봇]',
                '로봇코딩 강사 [블록&엔트리&스크래치 코딩]',
            ],
        ...
        },
        {
            name: '허유찬',
            title: '로봇 경진대회 전문강사',
            specialty: 'IROC·FIRA·로봇 경진대회 지도',
            image: '/img/hyc.png',
            skills: [
                { name: 'IROC Competition', level: 100 },
                { name: 'FIRA Competition', level: 95 },
                { name: 'AI Mission Racing', level: 100 },
                { name: 'Humanoid Robot', level: 100 },
            ],
            experience: [
                '지능휴머노이드대회 대통령상 수상',
                'STEAMCUP IRC 오토레이스 동상',
                'IROC AI미션레이싱, 로봇파밍 우승',
                '천안아산 청소년AI해커톤 최우수상',
                '물류로봇2-분류 금상, 동상',
                'FIRA HUROCUP JR 종합 수상',
                '물류로봇2-분류 금상',
                'Robo-One 인공지능 로봇 자율미션대회 입상',
                'IROC 응급구조 스탠다드 금상',
                'Biped soccer 3:3 금상',
            ],
        },
