                        ...
                        return (
                            ...
                            >
                                <div className="group relative bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-800 hover:border-sky-400/50 transition-all duration-300 hover:-translate-y-2">
                                    ...
                                    {achievement.logo ? (
                                        <div className="w-16 h-16 bg-white dark:bg-yellow-50 rounded-xl flex items-center justify-center mb-6 p-3 group-hover:scale-110 transition-all border-2 border-yellow-300 dark:border-yellow-200 shadow-lg">
                                            <Image
