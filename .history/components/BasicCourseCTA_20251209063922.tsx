                ...
                <ScrollAnimation direction="fade" delay={100}>
                    <div className="text-center bg-white dark:bg-gray-900 rounded-2xl sm:rounded-3xl p-8 sm:p-12 md:p-16 shadow-2xl border border-gray-100 dark:border-gray-800">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
                            ...
                            <button className="px-6 py-3 sm:px-8 sm:py-4 bg-white dark:bg-gray-800 active:bg-gray-50 dark:active:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-900 dark:text-white text-sm sm:text-base border-2 border-gray-200 dark:border-gray-700 font-bold rounded-full transition-all transform active:scale-95 hover:scale-105 touch-manipulation">
                                커리큘럼 자세히 보기
                            </button>
                        </div>
                    </div>
