                    ...
                    {outcomes.map((outcome, index) => {
                        ...
                        return (
                            <ScrollAnimation
                                ...
                                delay={index * 150}
                            >
                                <div className="group relative bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 dark:border-gray-800 hover:border-active-orange/50">
                                    {/* Check icon */}
