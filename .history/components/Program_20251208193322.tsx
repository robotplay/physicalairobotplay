...
export default function Program() {
    return (
        <section className="section-padding bg-humanoid-white dark:bg-[#111] relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    <ScrollAnimation direction="right" delay={100}>
                        <a
                            href="/basic-course"
                            className="group relative bg-white dark:bg-gray-900 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 overflow-hidden border border-gray-100 dark:border-gray-800 hover:border-active-orange/50 block"
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <button className="group/btn w-full py-3 rounded-xl border-2 border-active-orange text-active-orange font-bold hover:bg-active-orange hover:text-white transition-all flex items-center justify-center gap-2 hover:scale-105 active:scale-95">
                                    상세 커리큘럼
                    ...
                    <ScrollAnimation direction="left" delay={200}>
                        <div className="group relative bg-deep-electric-blue rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 overflow-hidden text-white hover:scale-[1.02]">
                            {/* Animated background blob */}
                            ...
                            <div className="relative z-10">
                                ...
                                <button className="group/btn w-full py-3 rounded-xl bg-white text-deep-electric-blue font-bold hover:bg-blue-50 transition-all flex items-center justify-center gap-2 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl">
                                    상세 커리큘럼
                                    <ArrowRight className="w-4 h-4 group-hover/btn:translate-x-1 transition-transform" />
                                </button>
                            </div>
