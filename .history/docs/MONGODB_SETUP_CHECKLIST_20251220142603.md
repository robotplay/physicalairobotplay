...
- [ ] (선택사항) 모든 IP 허용: "+ADD IP ADDRESS" → "ALLOW ACCESS FROM ANYWHERE" 선택
- [ ] (선택사항) "Confirm" 클릭
...
- [x] 연결 문자열 복사 ✅ (`mongodb+srv://hkj5345_db_user:<db_password>@academy-cluster.eekhbti.mongodb.net/...`)
- [ ] `<db_password>` 부분을 실제 비밀번호로 교체 (진행 중...)
