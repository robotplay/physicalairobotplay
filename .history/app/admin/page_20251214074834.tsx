...
import { Mail, Phone, User, MessageSquare, Calendar, X, Trash2, Eye, LogOut } from 'lucide-react';
                            ...
                            {consultations.map((consultation) => (
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="inline-block px-2 sm:px-3 py-1 bg-deep-electric-blue/10 text-deep-electric-blue rounded-full text-xs font-semibold">
                                    ...
                                    <div className="space-y-4 sm:space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="p-2 sm:p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                                <span className="inline-block px-2 sm:px-3 py-1 bg-deep-electric-blue text-white rounded-full text-xs sm:text-sm font-semibold">
